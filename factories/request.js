(function () {
    ...
    http.$inject = ['$http', '$sessionStorage', '$ionicLoading', '$q', 'toastr', 'Upload', '$localStorage'];

    /**
     * Wrapper over the standard http function
     */

    function http($http, $sessionStorage, $ionicLoading, $q, toastr, Upload, $localStorage) {
        ...
        function requestFile(method, url, data) {
